...
public class CardView extends FrameLayout {
    ...
    private CardStackView refStack;
    ...
    public void setHolderRef(CardStackView ref) {
        this.refStack = ref;
    }
    public CardStackView getHolderRef() {
    ...
    public void startLoading() {
        if (getState() == STATE_INPUT) {
            ...
            setData(state, "", STATE_LOADING, -1, 0, "", "Loading");
            stateData.setState(1, state);
        } if (getState() != STATE_LOADING) {
            setData("", STATE_LOADING, -1, 0, "", "Loading");
            setupUI();
        }
    }
    ...
    public void showMessage(String message) {
        if (getState() == STATE_INPUT) {
            HashMap<String, Object> state = stateData.cloneState();
            setData(state, "", STATE_MESSAGE, -1, 0, "Message", message);
            stateData.setState(1, state);
        } else {
            setData("", STATE_MESSAGE, -1, 0, "Message", message);
            setupUI();
        }
    }
