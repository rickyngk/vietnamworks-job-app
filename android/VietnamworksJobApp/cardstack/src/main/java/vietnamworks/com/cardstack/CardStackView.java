...
public class CardStackView extends FrameLayout {
    ...
    private CardStackViewDelegate delegate;
    ...
    protected void onFinishInflate() {
        ...
        front = (CardView) this.findViewById(R.id.ccs_front);
        mid = (CardView) this.findViewById(R.id.ccs_mid);
        back = (CardView) this.findViewById(R.id.ccs_back);
    ...
    public void onChildTouchEvent(CardView child, MotionEvent ev) {
    ...
    public CardView getFront() {return this.front;}
    public CardView getBack() {return this.back;}
    public CardView getMid() {return this.mid;}
                ...
                case STATE_PRE_INIT:
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            initLayout();
                            if (delegate != null) {
                                delegate.onLaunched(CardStackView.this);
                                refresh();
                            }
                    ...
                    if (delegate != null) {
                        ...
                        if (total > 0) {
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    delegate.onBeforeChangedActiveItem( (itemIndex + 1) % total, ((itemIndex + 1) + 1) % total,((itemIndex + 1) + 2) % total, CardStackView.this);
                                }
                            });
                        }
                    }
                            ...
                            set.addListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationStart(Animator animation) {
                                    if (delegate != null) {
                                        ...
                                        delegate.onBeforeSelectItem(index, CardStackView.this);
                                    }
                                }
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    ...
                                    if (delegate != null) {
                                        int total = delegate.getTotalRecords();
                                        int index = total==0?-1:(itemIndex%total);
                                        delegate.onSelectItem(index, CardStackView.this);
                                    }
                                }
                                    ...
                                    if (delegate != null) {
                                        handler.post(new Runnable() {
                                            ...
                                            public void run() {
                                                int total = delegate.getTotalRecords();
                                                int index = total==0?-1:(itemIndex%total);
                                                delegate.onDeselectItem(index, CardStackView.this);
                                            }
                                        });
                                    }
                                }
                            ...
                            set.addListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationStart(Animator animation) {
                                    if (delegate != null) {
                                        ...
                                        if (count == 0) {
                                            delegate.onBeforeSelectItem(-1, CardStackView.this);
                                        } else {
                                            delegate.onBeforeSelectItem(itemIndex % delegate.getTotalRecords(), CardStackView.this);
                                        }
                                    }
                                }
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    if (delegate != null) {
                                        int count = delegate.getTotalRecords();
                                        if (count == 0) {
                                            delegate.onSelectItem(-1, CardStackView.this);
                                        } else {
                                            delegate.onSelectItem(itemIndex % delegate.getTotalRecords(), CardStackView.this);
                                        }
                    ...
                    if (delegate != null) {
                        ...
                        if (total > 0) {
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    delegate.onChangedActiveItem(itemIndex % total, (itemIndex + 1) % total, (itemIndex + 2) % total, CardStackView.this);
                                }
                            });
                        }
