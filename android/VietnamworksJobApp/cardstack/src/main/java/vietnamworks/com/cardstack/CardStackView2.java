 ...
 */
public class CardStackView2 extends FrameLayout {
    CardHolder front, mid, back;
    FrameLayout holder;
    ...
    private CardStackViewDelegate2 delegate;
    ...
    public CardStackView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initializeViews(Context context) {
        ...
        inflater.inflate(R.layout.card_stack_layout_2, this);
    }
    ...
    public void setDelegate(CardStackViewDelegate2 delegate) {
    ...
    protected void onFinishInflate() {
        ...
        front = (CardHolder) this.findViewById(R.id.ccs_front);
        mid = (CardHolder) this.findViewById(R.id.ccs_mid);
        back = (CardHolder) this.findViewById(R.id.ccs_back);
    ...
    public void onChildTouchEvent(CardHolder child, MotionEvent ev) {
    ...
    public CardHolder getFront() {return this.front;}
    public CardHolder getBack() {return this.back;}
    public CardHolder getMid() {return this.mid;}
                ...
                case STATE_PRE_INIT:
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            initLayout();
                            if (delegate != null) {
                                delegate.onLaunched(CardStackView2.this);
                                refresh();
                            }
                    ...
                    if (delegate != null) {
                        ...
                        if (total > 0) {
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    delegate.onBeforeChangedActiveItem( (itemIndex + 1) % total, ((itemIndex + 1) + 1) % total,((itemIndex + 1) + 2) % total, CardStackView2.this);
                                }
                            });
                        }
                    }
                            ...
                            set.addListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationStart(Animator animation) {
                                    if (delegate != null) {
                                        ...
                                        delegate.onBeforeSelectItem(index, CardStackView2.this);
                                    }
                                }
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    if (delegate != null) {
                                        int total = delegate.getTotalRecords();
                                        int index = total==0?-1:(itemIndex%total);
                                        delegate.onSelectItem(index, CardStackView2.this);
                                    }
                                }
                                    ...
                                    if (delegate != null) {
                                        handler.post(new Runnable() {
                                            ...
                                            public void run() {
                                                int total = delegate.getTotalRecords();
                                                int index = total==0?-1:(itemIndex%total);
                                                delegate.onDeselectItem(index, CardStackView2.this);
                                            }
                                        });
                                    }
                                }
                            ...
                            set.addListener(new Animator.AnimatorListener() {
                                ...
                                public void onAnimationStart(Animator animation) {
                                    if (delegate != null) {
                                        ...
                                        if (count == 0) {
                                            delegate.onBeforeSelectItem(-1, CardStackView2.this);
                                        } else {
                                            delegate.onBeforeSelectItem(itemIndex % delegate.getTotalRecords(), CardStackView2.this);
                                        }
                                    }
                                }
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    if (delegate != null) {
                                        int count = delegate.getTotalRecords();
                                        if (count == 0) {
                                            delegate.onSelectItem(-1, CardStackView2.this);
                                        } else {
                                            delegate.onSelectItem(itemIndex % delegate.getTotalRecords(), CardStackView2.this);
                                        }
                    ...
                    if (delegate != null) {
                        ...
                        if (total > 0) {
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    delegate.onChangedActiveItem(itemIndex % total, (itemIndex + 1) % total, (itemIndex + 2) % total, CardStackView2.this);
                                }
                            });
                        }
